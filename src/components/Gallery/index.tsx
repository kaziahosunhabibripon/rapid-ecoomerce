...
const GalleryComponent = () => {
  ...
  return (
    <section>
      <CommonHeader title="Gallery" componentTitle="Gallery" />
      <div
        ...
        >
          <div className="container">
            <div className="text-center mb-12">
              <span className="inline-block bg-brand text-white uppercase text-xs font-semibold px-3 py-1 rounded-sm mb-2">
                discover suhaksa modern and decent abaya
              </span>
              <div className="flex justify-center items-center gap-2">
                {/* <ServeIcon /> */}
                <CommonTitle title="Discover our Abaya's" />
              </div>
              ...
              {galleryImages?.map((image, index) => (
                ...
                >
                  <div className="aspect-square relative">
                    ...
                    <div className="absolute inset-0 bg-[#42d868ab]/50 flex items-center justify-center transition-all duration-500 transform -translate-y-full group-hover:translate-y-0 opacity-0 group-hover:opacity-100">
