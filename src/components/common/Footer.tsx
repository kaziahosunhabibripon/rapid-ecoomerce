      ...
      <div className="w-full mx-auto container px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
          ...
          <div>
            ...
            <h2 className="flex items-start justify-items-start gap-1">
              <HiOutlinePhoneArrowDownLeft className="text-sky-500 mt-1" />
              +971562015468
            </h2>
            <h2 className="flex items-start justify-items-start gap-1">
              <MdOutlineMarkEmailRead className="text-sky-500 mt-1" />
              ...
              <div className="flex gap-1 mt-2">
                {footerSocialLinks?.map(({ link, icon: Icon }, index) => (
                  <Link
                    key={index}
                    href={link}
                    className="w-8 h-8 flex items-center justify-center rounded-full border border-gray-700 hover:bg-[#28ace2] hover:border-[#28ace2] hover:text-white transition-all duration-300 ease-in-out"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
