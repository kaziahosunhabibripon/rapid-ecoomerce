  ...
  return (
    <div className="w-full py-12 px-4 md:px-6 container mx-auto">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">Latest Posts</h1>
      </div>

      <div className="flex items-center justify-between border-b border-gray-300 mb-8">
        <h1 className="text-3xl font-bold text-gray-500 mb-2">Blogs</h1>

        <div className="flex flex-col">
          <span className="text-lg font-bold text-sky-500 mb-2">
            Explore More
          </span>
        </div>
      </div>
